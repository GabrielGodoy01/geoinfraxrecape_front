...
import 'confirm-new-password/presenter/controller/confirm_new_password_controller.dart';
...
class AuthModule extends Module {
  ...
  List<Bind> get binds => [
        ...
        Bind<ConfirmNewPasswordController>(
            (i) => ConfirmNewPasswordController(i())),
        ...
        Bind<ILoginWithNewPasswordUsecase>(
            (i) => LoginWithNewPasswordUsecase(repository: i())),
  ...
  List<ModularRoute> get routes => [
        ...
        ChildRoute(
          ...
          child: (context, args) => ConfirmNewPasswordPage(
              email: args.data['email'], password: args.data['password']),
        ),
      ];
}
